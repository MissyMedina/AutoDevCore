...
__version__ = "1.0.0"
__description__ = "Analyzes code complexity, quality metrics, and provides recommendations"
            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.FunctionDef):
                    ...
                    if function_info["complexity"] > 10:
                        analysis_results["complexity_metrics"]["high_complexity_functions"].append(function_info)
                    
                    if function_info["length"] > 20:
                        analysis_results["complexity_metrics"]["long_functions"].append(function_info)
