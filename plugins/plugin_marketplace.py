...
class PluginMarketplace:
    ...
    def __init__(
        self,
        marketplace_url: str = "https://api.github.com/repos/MissyMedina/AutoDevCore-Plugins/contents",
    ):
    ...
    def discover_plugins(
        self, category: str = None, search_term: str = None
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for plugin_file in self.plugins_dir.glob("*.py"):
                ...
                if plugin_info:
                    # Apply filters
                    if category and category.lower() not in plugin_info.get(
                        "categories", []
                    ):
                        continue
                    if (
                        ...
                        not in plugin_info.get("name", "").lower()
                    ):
                        continue
