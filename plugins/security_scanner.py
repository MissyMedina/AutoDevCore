...
__version__ = "1.0.0"
__description__ = "Scans code for common security vulnerabilities and provides remediation advice"
...
def run(context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    security_patterns = {
        ...
        "high": [
            ...
            (r"\.execute\s*\(\s*[^)]*\+", "Potential SQL injection - string concatenation"),
        ],
        "medium": [
            ...
            for severity, patterns in security_patterns.items():
                for pattern, description in patterns:
                    ...
                    for match in matches:
                        ...
                        security_results["vulnerabilities"][severity].append(vulnerability)
                        ...
                        if isinstance(node.func, ast.Name):
                            ...
                            if func_name in ['eval', 'exec', 'input']:
                                ...
                                if func_name in ['eval', 'exec']:
                                    security_results["vulnerabilities"]["critical"].append(vulnerability)
                                else:
                                    security_results["vulnerabilities"]["medium"].append(vulnerability)
