...
def create_user(username: str, email: str, password: str, role: UserRole = UserRole.ENTRYLVL_DEV) -> User:
    """Create a new user."""
...
if __name__ == "__main__":
    ...
    # Create test user
    user = create_user("testuser", "test@example.com", "password123", UserRole.SENIOR_DEV)
