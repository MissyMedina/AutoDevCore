...
class CollaborationIntegrationTest:
        ...
        try:
            ...
            async with websockets.connect(self.websocket_url) as websocket:
                ...
                return {
                    ...
                    "messages_sent": 2,
                    "messages_received": 2,
                    "response_types": [response_data.get('type'), broadcast_data.get('type')]
                }
    ...
    def test_team_management(self):
        ...
        try:
            ...
            print(f"✅ Permission test - Owner can edit: {can_edit}, can invite: {can_invite}")
    ...
    async def test_collaboration_platform(self):
        ...
        try:
            ...
            if project_result["success"]:
                print(f"✅ Created collaborative project: {project_result['project_name']}")
                ...
                # Get user dashboard
                dashboard_result = collaboration_platform.get_user_dashboard("test_owner_1")
