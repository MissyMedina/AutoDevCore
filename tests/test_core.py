...
class TestComposeMode:
    ...
    def test_execute_success(self, mock_readme, mock_code, mock_prd, mock_composer):
        ...
        mock_code.return_value.generate_codebase.return_value = {"main.py": "print('hello')"}
...
class TestScoreMode:
    ...
    def setup_method(self):
        ...
        self.score_mode = ScoreMode(self.app_dir, "profiles/fintech.yaml", self.temp_dir, verbose=True)
...
class TestGPTOSSClient:
    ...
    def test_generate_with_error(self):
        ...
        with patch.object(self.client, '_make_request', side_effect=Exception("test error")):
...
class TestIntegration:
    ...
    def test_full_score_workflow(self):
        ...
        score_mode = ScoreMode(app_dir, "profiles/fintech.yaml", self.temp_dir, verbose=True)
