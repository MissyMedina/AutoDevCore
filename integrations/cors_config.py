...
class CORSMiddleware:
    ...
    def add_cors_headers(self, response_headers: Dict[str, str], origin: str = None):
        ...
        response_headers['Access-Control-Allow-Methods'] = ', '.join(self.config.allowed_methods)
        response_headers['Access-Control-Allow-Headers'] = ', '.join(self.config.allowed_headers)
    ...
    def handle_preflight(self, request_method: str, request_headers: List[str]) -> Dict[str, Any]:
...
class CORSManager:
            ...
            try:
                with open(self.config_file, 'r') as f:
                    ...
                    return CORSConfig(
                        ...
                        allowed_methods=data.get('allowed_methods', ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS']),
    ...
    def create_secure_config(self) -> CORSConfig:
        ...
        return CORSConfig(
            allowed_origins=['http://localhost:3000', 'http://localhost:8501'],  # Specific origins
            allowed_methods=['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'is_secure': not ('*' in self.config.allowed_origins and self.config.allow_credentials)
        }
