...
class PluginMode(BaseMode):
    ...
    def __init__(self, name: str = None, output_dir: str = "./output", verbose: bool = False, 
                 list_plugins: bool = False, generate_docs: bool = False):
    ...
    def _list_available_plugins(self):
        ...
        for plugin_name, info in plugins.items():
            ...
            print(f"   Status: {'✅ Ready' if info.get('valid', False) else '❌ Invalid'}")
    ...
    def _load_plugin_safely(self):
        ...
        try:
            ...
            if len(sig.parameters) < 1:
                print(f"Plugin {self.name} run function must accept at least one parameter")
                return None
    ...
    def _generate_plugin_documentation(self):
        ...
        with open(doc_file, 'w') as f:
            ...
            f.write("## Overview\n\n")
            f.write("This document provides comprehensive documentation for all available AutoDevCore plugins.\n\n")
            ...
            f.write("3. Add metadata (optional): `__author__`, `__version__`, `__description__`\n")
            f.write("4. Test your plugin with `python cli.py --mode plugin --name your_plugin`\n\n")
            ...
            f.write("    \n")
            f.write("    Args:\n")
            f.write("        context (dict): Execution context with plugin_name, output_dir, verbose\n")
            f.write("    \n")
            f.write("    Returns:\n")
            ...
            for plugin_name, info in plugins.items():
                ...
                f.write(f"**Status**: {'✅ Ready' if info['valid'] else '❌ Invalid'}\n\n")
    ...
    def _generate_execution_report(self, plugin_info: Dict[str, Any], result: Any):
        ...
        with open(report_file, 'w') as f:
            ...
            f.write(f"- **Status**: {'✅ Valid' if plugin_info['valid'] else '❌ Invalid'}\n\n")
