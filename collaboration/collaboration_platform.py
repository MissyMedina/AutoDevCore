...
class CollaborationPlatform:
    ...
    def invite_to_project(
        ...
        try:
            ...
            invitation = team_manager.create_invitation(
                team_id=team_id, email=email, role=role, invited_by=invited_by
            )
    ...
    def get_project_status(
        self, team_id: str, workspace_id: str, user_id: str
    ) -> Dict[str, Any]:
    ...
    def update_project_data(
        self, workspace_id: str, team_id: str, user_id: str, data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Update project data with permission checking."""
        try:
            # Check if user has edit permission
            if not team_manager.has_permission(
                team_id, user_id, Permission.EDIT_PROJECT
            ):
                return {
                    "success": False,
    ...
    def get_collaboration_analytics(self, team_id: str, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not team_manager.has_permission(
                team_id, user_id, Permission.VIEW_ANALYTICS
            ):
                return {
                    "success": False,
    ...
    def get_platform_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.platform_stats["total_workspaces"] = len(
                collaboration_manager.workspaces
            )
            self.platform_stats["total_teams"] = len(team_manager.teams)
            self.platform_stats["active_connections"] = len(
                collaboration_manager.user_connections
            )
